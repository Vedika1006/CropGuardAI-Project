      ...
      >
        <View style={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Protecting crops with AI technology</Text>
          </View>

          <View style={styles.card}>
            <Text style={styles.cardTitle}>{t('login', language)}</Text>
            ...
            <View style={styles.footer}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('SignUp' as never)}>
                <Text style={styles.footerLink}>{t('signup', language)}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
